...
const products = [
  ...
  {id:16,name:"API для внешних витрин", description:"Для запуска внешних витрин в \"ТБанк\", \"ВТБ\" необходимо реализовать сервис и публичный API, позволяющие внешним витринам создавать заказы в OMS RTE и получать актуальную информацию о ресторанах (активность, адрес, график работы, меню и тд).", frontend:2, backend:50, category:"integration", effect:"Ожидаем эффект"},
